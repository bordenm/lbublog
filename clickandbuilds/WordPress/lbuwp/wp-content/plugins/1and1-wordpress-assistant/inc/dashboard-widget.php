...
class One_And_One_Assistant_Dashboard_Widget {
	...
	public function add_styles_scripts() {
		wp_register_style( '1and1-assistant-dashboard-widget', One_And_One_Assistant::get_css_url( 'assistant-dashboard-widget.css' ), array(), One_And_One_Assistant::VERSION );
